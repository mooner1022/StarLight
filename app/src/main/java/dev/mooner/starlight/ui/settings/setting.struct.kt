/*
 * setting.struct.kt created by Minki Moon(mooner1022) on 8/3/23, 10:11 PM
...
context(Fragment)
internal fun getSettingStruct(adapter: ConfigAdapter?) = config {
    category {
        id = "general"
        title = "일반"
        icon = Icon.SETTINGS
    ...
    category {
        ...
        items {
            ...
            toggle {
                ...
                warnOnEnable {
                    """
                    |이 기능은 신뢰할 수 없는 코드를 기기에서 실행할 수 있으며, 이로 인해 발생하는 어떠한 상해나 손실도 개발자는 보상하거나 보장하지 않습니다.
                    |기능을 활성화 할까요?
                    """.trimMargin()
                }
            }
