/*
 * ProjectUtils.kt created by Minki Moon(mooner1022)
...
inline fun <reified T: Event> Project.callEvent(args: Array<out Any>, noinline onException: (e: Throwable) -> Unit = {}): Boolean {
